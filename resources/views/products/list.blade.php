...
<main>
    <form action="{{ route('products.list') }}" method="get" class="search-form">
        ...
        <button type="submit" class="button">
            <svg width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                <path fill-rule="evenodd" d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398l3.85 3.85a1 1 0 0 0 1.415-1.415l-3.85-3.85zm-5.242 1.656a5 5 0 1 1 0-10 5 5 0 0 1 0 10z"></path>
            </svg>
            Search
        </button>
    ...
    <nav>
            ...
            @can('create', \App\Models\Product::class)
                <a href="{{ route('products.create-form') }}" class="new-product-link">New Product</a> 
            @endcan
