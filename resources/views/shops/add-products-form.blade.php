...
<main>
    <nav>
        <a href="{{ route('shops.view-products', ['shop' => $shop->code]) }}" class="back-link">
            &lt; Back
        </a>
    </nav>
    ...
    <!-- Search Form -->
    <form action="{{ route('shops.add-product', ['shop' => $shop->code]) }}" method="get">
        @csrf
        <label>
            Search ::
        ...
        <a href="{{ route('shops.add-product', ['shop' => $shop->code]) }}">
